...
public class MainPage extends PageObject {
    ...
    public static Target COMPLETE = Target.the("Palabras por completar").locatedBy("//input[@ng-model='todo.completed']");
    public static Target COMPLETED_BUTTON = Target.the("Palabras completadas").locatedBy("//a[@href='#/completed']");
}
